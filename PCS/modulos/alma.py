...
class Alma(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.sprites = [
        pygame.image.load('UnderGaragem-Baixar-e-jogar\\PCS\\assets\\sprites\\alma.png'),
        pygame.image.load('UnderGaragem-Baixar-e-jogar\\PCS\\assets\\sprites\\almaazul.png'),
        pygame.image.load('UnderGaragem-Baixar-e-jogar\\PCS\\assets\\sprites\\almaverde.png'),    
        ]
        self.game_over = pygame.image.load('UnderGaragem-Baixar-e-jogar\\PCS\\assets\\sprites\\almaquebrada.png')
        self.estado = 0
    ...
    def update(self):
        ...
        if self.acertavel == False:
            self.image = pygame.image.load('UnderGaragem-Baixar-e-jogar\\PCS\\assets\\sprites\\almavazia.png')
        else:
            self.image = self.sprites[self.estado]
        self.image = pygame.transform.scale(self.image, (16, 16))
